...
export interface ICombinationOptions {
    /**
     * Optional label for debugging or developer tools.
     */
    label?: string

    /**
     * Whether the combination should be active (reactive) initially.
 ...
 */
export abstract class $Combination<TValue> extends $Set<TValue> {
    /**
     ...
     */
    constructor(options: ICombinationOptions) {
        super(options)
     ...
     * @internal
     */
    protected get isLocallyEnabled() {
        return this.#isLocallyEnabled
    }
     ...
     * @internal
     */
    protected set isLocallyEnabled(value) {
